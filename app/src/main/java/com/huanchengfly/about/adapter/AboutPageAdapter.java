...
public class AboutPageAdapter extends BaseAdapter<AboutPage.Item> {
    ...
    protected void convert(ViewHolder viewHolder, AboutPage.Item item, int position) {
        int textColor = XposedApp.getColorByAttr(mContext, android.R.attr.textColorPrimary, R.color.color_text_light);
        int secondaryTextColor = XposedApp.getColorByAttr(mContext, android.R.attr.textColorSecondary, R.color.color_text_secondary_light);
